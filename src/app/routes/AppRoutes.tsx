...
import { MyWeeklyScheduleSection } from "../pages/my-space/my-attendance/components/sections/MyWeeklySchedule.section";
import { MyRequestsRoutes } from "../pages/my-space/my-requests/routes/MyRequestsRoutes";
          ...
          <Route element={<AccessGuard />}>
            ...
            <Route element={<OutledMainLayout />}>
              ...
              <Route path="my-attendance" element={<MyAttendancePage />}>
                <Route path="/" element={<MyWeeklyScheduleSection />} />
                <Route path="/marking-day" element={<Foo />} />
              </Route>
